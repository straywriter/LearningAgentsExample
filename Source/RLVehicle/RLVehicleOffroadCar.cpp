...
#include "RLVehicleOffroadCar.h"
#include "RLVehicleOffroadWheelFront.h"
#include "RLVehicleOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

ARLVehicleOffroadCar::ARLVehicleOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = URLVehicleOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = URLVehicleOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = URLVehicleOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = URLVehicleOffroadWheelRear::StaticClass();
